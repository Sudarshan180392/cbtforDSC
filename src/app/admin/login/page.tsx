...
export default function AdminLoginPage() {
  ...
  if (status === "loading") return <div className="flex-1 flex items-center justify-center">Loading...</div>;

  return (
    <div className="flex-1 flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-2xl font-bold mb-2 text-center text-blue-900">Admin Panel Login</h2>
        <p className="text-center text-gray-500 text-sm mb-6">Only authorized administrators can access this panel.</p>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-300 hover:border-blue-500 hover:bg-blue-50 text-gray-700 font-semibold py-3 px-4 rounded-lg mb-4 transition-colors"
        >
          ...
          Sign in with Google (Superadmin only)
        </button>
        ...
        <div className="mt-4 text-center">
          <a href="/login" className="text-sm text-blue-600 hover:underline">← Back to Student Login</a>
        </div>
      </div>
    </div>
  );
